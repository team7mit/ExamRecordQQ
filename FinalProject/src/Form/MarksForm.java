...
public class MarksForm extends dataentry implements ActionListener{
	...
	public static void getTotalMark(DefaultTableModel model1) {
		...
		try {
			...
			JOptionPane.showMessageDialog(frame,"Marks Type is Wrong CHECK AGAIN","FONT ERROR",JOptionPane.WARNING_MESSAGE);
		}
		catch(NullPointerException e) {
			
			JOptionPane.showMessageDialog(frame," Insert Marks","Mark Not Fill",JOptionPane.WARNING_MESSAGE);
		}
	...
	public static void start() {
		try {
			...
			for(StudentModel student: list) {
				...
				frame.dispose();
				JOptionPane.showMessageDialog(frame,"No Student","No Data",JOptionPane.WARNING_MESSAGE);
			}
			...
			JOptionPane.showMessageDialog(frame," No Subject ","No Data",JOptionPane.WARNING_MESSAGE);
		}
